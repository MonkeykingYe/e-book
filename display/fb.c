...
static int FBDeviceInit(void)
{
	...
	g_tFBDisOpr.iXres = g_tVar.xres;
	g_tFBDisOpr.iYres = g_tVar.yres;
	g_tFBDisOpr.iBpp = g_tVar.bits_per_pixel;
...
static int FBShowPixel(int iPenX, int iPenY, unsigned int dwColor)
{
	if ((iPenX >= g_tVar.xres) || (iPenY>= g_tVar.yres))
	{
